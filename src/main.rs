...
use std::{env, fs::File, str::FromStr, process::exit};

/// Try to determine of `c` is in the Mandelbrot set, using at most `limit`
...
fn parse_complex(s: &str) -> Option<Complex<f64>> {
	...
	// the line above is the same like the lines below:
	// match parse_pair(s, ',') {
